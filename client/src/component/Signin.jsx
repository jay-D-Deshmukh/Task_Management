...
function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if(userName!="" && email!="" && password !=""){
      ...
      axios
      .post("http://localhost:5010/api/user/register", userData)
      .then((response) => {
  ...
  return (
    ...
    <div
      ...
      style={{
        backgroundImage: `url('https://img.freepik.com/free-vector/flat-design-kanban-illustration_23-2149337644.jpg?size=626&ext=jpg')`,
      }}
